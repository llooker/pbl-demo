    ...
    <Grid item sm={12}>
      <EmbedMethodHighlight classes={classes}
        ...
        <Slider
          ...
          min={Array.isArray(apiContent[index]) ? apiContent[index][0].label : 0}
          max={Array.isArray(apiContent[index]) ? apiContent[index][apiContent[index].length - 1].label : 0}
          marks={Object.keys(apiContent[index][0]) ? [{ value: apiContent[index][0].label, label: apiContent[index][0].label }, { value: apiContent[index][apiContent[index].length - 1].label, label: apiContent[index][apiContent[index].length - 1].label }] : ''}
